...
function CartPage() {
  ...
  return (
    <div data-testid="cart-page">
          ...
          <table className="min-w-full divide-y divide-gray-line">
            <thead className="bg-gray-lighter">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-txt uppercase">Count</th>
      ...
      <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-line p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
